...
//TO DO:
//-ADD CODE TO ACCEPT AN END DATE
//-CHANGE DURATION TO CHANGE WHEN GIVEN A START AND END TIME
...
public class Assignment2 {
    public static void main(String[] args){
        ...
        System.out.print("\nWelcome to your calender "+ event.getCreator() + "!\nEnter a date and time " +  "Format: 2010-01-01 12:00 (24 Hour time): ");
        ...
        //closing statement that displays the created event
